...
cd ./operator
for filename in {"advection_aligned_pideeponet_2d","advection_aligned_pideeponet","advection_unaligned_pideeponet_2d","advection_unaligned_pideeponet","antiderivative_aligned_pideeponet","diff_rec_aligned_pideeponet","diff_rec_unaligned_pideeponet","stokes_aligned_zcs_pideeponet"}
...
cd ./pinn_forward
for filename in {"Allen_Cahn","Beltrami_flow","fractional_Poisson_3d","heat_resample","Helmholtz_Dirichlet_2d_HPO"}
...
cd ./pinn_inverse
for filename in {"fractional_Poisson_2d_inverse","reaction_inverse"}
